    ...
    def deletenode(self,data):
        ...
        #현재 노드가 지워야 할 노드일 경우
            ...
            #저장하고 오른쪽 자식으로 이동
                ...
                #현재노드의 왼쪽 자식이 비어 있을 경우
                #현재노드와 원래 지워야 할 노드의 데이터를
                #교환 후 현재노드의 오른쪽 자식을 지워야 할
                #노드의 오른쪽 자식으로 연결해준다
                if self.left==None:
                ...
                #현재노드의 왼쪽 자식이 있을 경우 최대한
                #왼쪽자식으로 이동후 지워야 할 노드의 데이터와
                #교환하고 노드를 삭제한다
                #즉, 지워야 할 노드보다 큰 데이터 중 가장 작은
                #데이터로 교환하는 것을 뜻한다.
                else:
            ...
            #저장하고 왼쪽 자식으로 이동
                ...
                #오른쪽 자식이 있을 경우
                    ...
                    #오른쪽 자식이 없을 때까지 현재노드를
                    #부모노드로 저장하고 오른쪽으로 이동한 뒤
                    #지워야 할 노드의 데이터와 교환하고
                    #현재노드를 삭제
